        ...
        <aside className="sticky top-0 hidden h-screen border-r border-neutral-200 bg-white lg:flex lg:flex-col">
          ...
          <div className={cn("border-b border-neutral-100 py-5 transition-all duration-300", sidebarCollapsed ? "px-0" : "px-6")}>
            <div className={cn("flex items-center", sidebarCollapsed ? "justify-center gap-0" : "gap-3")}>
              <Link href="/admin" className={cn("grid shrink-0 place-items-center bg-black text-white transition-all duration-300", sidebarCollapsed ? "size-11 rounded-2xl" : "size-11 rounded-2xl")}>
                <ShoppingBag className={cn(sidebarCollapsed ? "size-4" : "size-5")} />
              </Link>
